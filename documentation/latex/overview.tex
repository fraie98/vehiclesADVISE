...
\begin{table}[htpb]
	...
	Hacker            & \begin{tabular}[c]{@{}c@{}}Reverse engineering,\\ social engineering,\\ advanced attack and\\ penetration skills\end{tabular} & -                                                                                                                                                           & \begin{tabular}[c]{@{}c@{}}Vehicle\\ (i.e. Firmware)\end{tabular}                                            \\ \hline
	Physical Intruder & \begin{tabular}[c]{@{}c@{}}Lockpicking, \\ Basic/medium\\ IT skills\end{tabular}                                              & \begin{tabular}[c]{@{}c@{}}Facilities location,\\ personnel timetables\end{tabular}                                                                         & \begin{tabular}[c]{@{}c@{}}Server \\ Physical Access\end{tabular}                                            \\ \hline
	Insider           & \begin{tabular}[c]{@{}c@{}}Basic/medium IT\\ skills\end{tabular}                                                              & \begin{tabular}[c]{@{}c@{}}Login credentials\\ (website, LAN,\\ VPN, DB),\\ employees info,\\ vulnerabilities in\\ company's security\\ system\end{tabular} & \begin{tabular}[c]{@{}c@{}}LAN, VPN, DB,\\ facilities, PCs,\\ workstations,\\ routers, switches\end{tabular} \\ \hline
	\end{tabular}
